...
<div class="card shadow">
  <div class="card-body">
	<form action="<?= base_url("kasir/edit")?>" method="post">
	<input type="hidden" name="ID_Kasir" value="<?php echo $kasir->ID_Kasir?>">
		<div class="form-group row">
		<label class="form-label col-4" for="inputEmail">Username</label>
		<div class="col-8">
            <input type="text" name="Username" value="<?php echo $kasir->Username?><?php echo set_value('Username'); ?>" class="form-control">
		...
		<label class="form-label col-4" for="inputEmail">Nama Kasir</label>
			<div class="col-8">
							<input type="text" name="NamaKasir" value="<?php echo $kasir->NamaKasir?><?php echo set_value('NamaKasir'); ?>" class="form-control">
		...
		<label class="form-label col-4" for="inputEmail">Alamat</label>
			<div class="col-8">
							<input type="text" name="Alamat" value="<?php echo $kasir->Alamat?><?php echo set_value('Alamat'); ?>" class="form-control">
		...
		<label class="form-label col-4" for="inputEmail">Nomor HP</label>
			<div class="col-8">
							<input type="text" name="NomorHP" value="<?php echo $kasir->NomorHP?><?php echo set_value('NomorHP'); ?>" class="form-control">
		...
		<label class="form-label col-4" for="inputEmail">Nomor KTP</label>
			<div class="col-8">
							<input type="text" name="NomorKTP" value="<?php echo $kasir->NomorKTP?><?php echo set_value('NomorKTP'); ?>" class="form-control">
