...
<div class="card shadow">
  <div class="card-body">
	<form action="<?= base_url("barang/add")?>" method="post">
		...
		<div class="col-8">
            <input type="text" name="Nama_Barang" value="<?php echo set_value('Nama_Barang'); ?>" class="form-control">
		...
		<div class="col-8">
            <input type="text" name="HargaSatuan" value="<?php echo set_value('HargaSatuan'); ?>" class="form-control">
